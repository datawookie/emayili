...
You can find the test coverage report at [Codecov](https://app.codecov.io/gh/datawookie/emayili). For developmnent purposes it's more convenient to use the [`{covr}`](https://cran.r-project.org/package=covr) package.
